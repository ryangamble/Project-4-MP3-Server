...
final class ClientHandler implements Runnable {
    ...
    public void run() {
        ...
        try {
            ois = new BufferedReader(new InputStreamReader(this.clientSocket.getInputStream()));
            bWriter = new BufferedWriter(new OutputStreamWriter(this.clientSocket.getOutputStream()));
            input = ois.readLine();
            if()
    ...
    private void sendByteArray(byte[] songData) {
        try {
            byte[] splitData = readSongData("someFile");
